                ...
                success : function(xml){
                        ...
                        $(xml).find("item").each(function(){
                                ...
                                for(var i=0;i<datas.length;i++){
                                	var total=new XMLSerializer().serializeToString(datas[i])+"<br/>"
                                			+ new XMLSerializer().serializeToString(datas2[i])+"<br/>"
                                			+ new XMLSerializer().serializeToString(datas3[i])+"<br/>"
                                			+ new XMLSerializer().serializeToString(datas4[i])+"<br/>"
